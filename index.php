...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-dark">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-link">
        <button type="button" class="btn bg-terps-gold text-black black-hover" data-toggle="modal"data-target="#login">
          Login
        </button>
      </li>
      <li class="nav-link">
        <button type="button" class="btn bg-terps-gold text-black black-hover" data-toggle="modal" data-target="#register">
          Register
        </button>
      </li>
    </ul>
      ...
      <div class="row">
        ...
        <div class="col-8 bg-faded-yellow jumbo-margin rounded">
          ...
          <div class="col-12 text-center pb-3">
            <button type="button" class="btn btn btn-lg bg-terps-red text-white" data-toggle="modal" data-target="#register">
              Register Now
            </button>
          </div>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form>
          ...
          <!-- Modal footer -->
          <div class="modal-footer">
            <input type="submit" class="btn btn-danger" data-dismiss="modal" value="Login">
          </div>
        </form>
